...
"Back in February":/2013/02/19/omniauth-google-oauth2-example.html I wrote a blog post about omniauth + Google OAuth2 on Rails. This article stopped short of doing anything useful once the OAuth2 credentials had been obtained. This article revises my current thinking on how best to use OAuth2 + Google in a Rails app, but importantly goes the extra mile of offering some code that pulls data from the "Google Calendar API":https://developers.google.com/google-apps/calendar/
