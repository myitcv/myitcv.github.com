...
Time to tidy up a couple of files that we no longer need. Back to the terminal:
...
You should now be presented with a page that includes a *Client ID* and *Client secret*. 
