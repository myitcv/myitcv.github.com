...
The padding override allows us to accommodate the "Bootstrap black nav bar":http://twitter.github.com/bootstrap/examples/hero.html (which is grey and not black in my default installation of @bootstrap-sass@).
